...
export function ConditionalLayout({ children, isAdminRoute: initialIsAdminRoute }: ConditionalLayoutProps) {
  const pathname = usePathname()
  const isAdminRoute = initialIsAdminRoute ?? pathname?.startsWith('/admin') ?? false
