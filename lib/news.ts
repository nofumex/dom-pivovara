...
const newsData: NewsItem[] = [
  {
    ...
    content:
      'Мы запустили обновлённый сайт ДомПивовар с современным дизайном, удобной навигацией и улучшенным каталогом товаров. Теперь искать оборудование и ингредиенты для пивоварения стало ещё проще.',
  },
]
